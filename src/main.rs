...
static MEMORY: Lazy<Arc<RwLock<Memory>>> = Lazy::new(|| Arc::from(RwLock::from(Memory::new())));
static SCOPES: Lazy<Arc<RwLock<HashMap<u128, Arc<Mutex<runtime::scope::Scope>>>>>> =
  Lazy::new(|| Arc::from(RwLock::from(HashMap::new())));
